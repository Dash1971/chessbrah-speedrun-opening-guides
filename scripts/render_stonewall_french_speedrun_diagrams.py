...
SETS = {
    ...
    "french-speedrun": {
        ...
        "diagrams": [
            ...
            ("diagram-08-exchange-long-castle.svg", "Aman's aggressive Exchange setup", "e4 e6 d4 d5 exd5 exd5 Nf3 Bd6 Bg5 f6 Be3 Ne7 Nc3 c6 Qd2 Bf5 O-O-O Nd7", [arrow("d8d7", BLUE), arrow("e8c8", BLUE), arrow("h7h5"), arrow("g7g5")], [arrow("c8c8", YELLOW)]),
            ...
            ("diagram-11-winawer.svg", "Winawer: damage the centre, then attack it", "e4 e6 d4 d5 Nc3 Bb4 e5 c5 a3 Bxc3+ bxc3 Ne7", [arrow("d8a5", BLUE), arrow("b8c6"), arrow("c5d4", RED)], [arrow("c3c3", RED), arrow("d4d4", RED)]),
            ("diagram-12-tarrasch.svg", "Tarrasch: challenge d4 with c5", "e4 e6 d4 d5 Nd2 c5 exd5 exd5 Ngf3 Nc6 Bb5", [arrow("g8f6"), arrow("c8d6", BLUE)], [arrow("d4d4", RED)]),
            ...
            ("diagram-14-kia.svg", "Against a King's Indian Attack, keep the centre", "Nf3 e6 g3 d5 Bg2 Nf6 O-O Be7 d3 O-O Nbd2 c5 e4 Nc6", [arrow("c5c4"), arrow("d5d4"), arrow("d8c7", BLUE)], [arrow("d5d5", YELLOW)]),
